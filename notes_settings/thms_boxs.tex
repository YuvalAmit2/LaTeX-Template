...
% \NewTColorBox[use counter=maincounter, number within=section, crefname={Example}{Examples}]{ex}{O{} O{}}
% {mybox,
% exbox,
...
% You can ignore everything from here to \declaretheoremstyle. There were some conflicts with TeX live 2026 and thmtools that were causing unnecessary compiling errors.
\makeatletter
